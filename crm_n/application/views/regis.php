                                        ...
                                        <table class="table table-bordered">
                                            <tbody><tr>
                                                ...
                                                <td width="20%">
                                           		...
                                           		<th>percentage</th>
                                                <td>
                                                	<input type="number" name="percentage" placeholder="%" id="percentage" class="form-control">
                                                </td>
                                            </tr>
									<tr >
                                          <th width="14%">Installment-date</th>
                                                ...
                                                <td width="20%">
                                                	<input type="number" name="insamount" class="form-control" id="insamount" onkeypress="return isNumberKey(event);" onFocus="getinsamount()">
                                                </td>
